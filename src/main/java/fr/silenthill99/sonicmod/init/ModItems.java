...
public class ModItems
{
    ...
    public static final RegistryObject<ForgeSpawnEggItem> TAILS_SPAWN_EGG = ITEMS.register("tails_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.TAILS, 0xFF6600, 0xffffff, new Item.Properties().tab(ModItemGroups.sonic)));
